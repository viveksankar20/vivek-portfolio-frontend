...
<div className='flex flex-wrap justify-center lg:flex-row flex-col  gap-5'>
        <div className='bg-[#14151D] lg:w-[40%] min-h-[250px] w-full border border-[#0173ca] rounded-lg'>
        ...
        <div className='bg-[#14151D] border border-[#0173ca] rounded-lg lg:w-[40%] min-h-[250px] w-full '>
